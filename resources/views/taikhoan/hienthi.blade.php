                        ...
                        <div class="row justify-content-center mb-2">
                            <div class="container">
                                <div class="row mb-1">
                                    ...
                                    <label name="ND_MaND" class="col-6 col-sm-6 btn">{{$hienthi->ND_MaND}}</label>
                                </div>
                                <div class="row mb-1">
                                    <div class="col-6 col-sm-6">Tên người dùng:</div>
                                    <label name="name" class="col-6 col-sm-6 btn">{{$hienthi->name}}</label>
                                </div>

                                <div class="row mb-1">
                                    <div class="col-6 col-sm-6">Giới tính:</div>
                                    <label name="ND_GioiTinh" class="col-6 col-sm-6 btn">{{$hienthi->ND_GioiTinh}}</label>
                                </div>

                                <div class="row mb-1">
                                    <div class="col-6 col-sm-6">Địa chỉ:</div>
                                    <label name="ND_DiaChi" class="col-6 col-sm-6 btn">{{$hienthi->ND_DiaChi}}</label>
                                </div>

                                <div class="row mb-1">
                                    <div class="col-6 col-sm-6">Email:</div>
                                    <label name="email" class="col-6 col-sm-6 btn">{{$hienthi->email}}</label>
                                </div>
