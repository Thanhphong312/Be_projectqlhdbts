                ...
                <div class="alert alert-primary">
                    ...
                    <form method="post" action="{{route('tram-update', $sua->T_MaTram)}}">
                        ...
                        <div class="mb-3 text-left">
                            ...
                            <input required value="{{$sua->T_TenTram}}" name="T_TenTram" class="form-control" type="text">
                        </div>
                        <div class="mb-3 text-left">
                            <label class="form-label">Địa chỉ
                                <span id="colorIcon">*</span>
                            </label>
                            <input required value="{{$sua->T_DiaChiTram}}" name="T_DiaChiTram" class="form-control" type="text">
                        </div>
                        <div class="mb-3 text-left">
